<template>
    <div class="w-[calc(100%+5px)] h-[181px] flex justify-between items-start gap-[24px] py-[24px] px-[16px] border-y-2 border-silver">
      ...
      <div class="w-[242px] h-full flex flex-col justify-between items-start">
        ...
        <div class="w-full flex justify-end  items-center gap-[30px]">
          ...
          <button class="h-[32px] w-[32px] ml-[20px]"
            @click="removeFromCart"
          ><img src="../assets/images/cart/remove.svg" alt=""></button>
...
export default defineComponent({
  ...
  methods: {
    removeFromCart() {
      this.$emit('remove-from-cart', this.cartItem.id);
    }
  }
});
</script>
